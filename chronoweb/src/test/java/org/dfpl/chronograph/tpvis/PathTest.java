...
public class PathTest {
    ...
    public static void setUpBeforeClass() {
        ...
        EDGE_LABEL = "label";
        KAIROS_PROGRAM_NAME = "OutIsAfterPathReachability";
        SOURCE_VERTEX_ID = "8";
        SOURCE_TIME = "0";
        GRAPH_FILE = "C:\\Users\\haifa\\Desktop\\datasets\\CollegeMsg.txt";
    }

    @Test
    public void testIsOutAfterPathReachability() throws IOException, InterruptedException {
    ...
    private static void subscribe() throws IOException {
        ...
        String subsribeURL = String.format("%s/graph/%s/OutIsAfterPathReachability/%s/%s", HOST, SOURCE_TIME, EDGE_LABEL, SOURCE_VERTEX_ID);
